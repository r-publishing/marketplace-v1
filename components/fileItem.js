      ...
      <div className={`card shadow-sm ${styles.customCard}`}>
       ...
       <div className="card-body">
        ...
        <div className="btn-group">
            <button type="button" className="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#setPriceModal" onClick={() => getNftData(file)}>Publish on marketplace</button>
            </div>
...
{/* <!-- Modal --> */}
<div className="modal fade" id="setPriceModal" tabIndex="-1" role="dialog" aria-hidden="true">
  <div className="modal-dialog modal-dialog-centered" role="document">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLongTitle">Publish on public marketplace</h5>
        <button type="button" className="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div className="modal-body">
      <label htmlFor=""><b>Set Price</b></label>
            <input type="text" className="form-control" id="name" aria-describedby="" placeholder="Enter Price in Rev" value={price} onChange={handlePriceChange}/>
      </div>
      <div className="modal-footer">
        <button type="button" className="btn btn-secondary" data-dismiss="modal">Cancel</button>
        <button type="button" className="btn btn-outline-danger" onClick={handleSubmit}>Publish</button>
      </div>
    </div>
  </div>
</div>
